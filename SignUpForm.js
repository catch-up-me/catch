    ...
    >
      ...
      >
        ...
        >
          <div
            ...
            style={{
              ...
              border: 'none',
              boxShadow:
                activeTab === 'Phone' ? '0 2px 8px rgba(0,0,0,0.1)' : 'none',
            }}
          >
            Phone
          </div>
          <div
            ...
            style={{
              ...
              border: 'none',
              boxShadow:
                activeTab === 'Email' ? '0 2px 8px rgba(0,0,0,0.1)' : 'none',
            }}
          >
            Email
          </div>
        ...
        <button
          style={{
            width: '100%',
            background: isFormValid() ? '#749cbf' : '#ddd',
            color: 'white',
            border: 'none',
            borderRadius: '12px',
            padding: '12px',
...
// Required for the CDN + Babel setup
