      ...
      <main className="flex-1 bg-white overflow-y-auto" style={{ backgroundColor: '#e5ddd5' }}>
        <div className="max-w-3xl mx-auto px-5 py-5">
          ...
          <div className="flex justify-start mb-2" style={{ animation: 'slideIn 0.3s ease-out' }}>
            <div className="relative max-w-[85%] min-w-[250px] bg-white rounded-lg p-2 px-3" style={{ boxShadow: '0 1px 2px rgba(0, 0, 0, 0.1)' }}>
              ...
              <div className="text-xs text-right" style={{ color: '#667781' }}>10:40 AM</div>
            </div>
          </div>
          ...
          <div className="flex justify-start mb-2" style={{ animation: 'slideIn 0.3s ease-out' }}>
            <div className="relative max-w-fit bg-white rounded-lg" style={{ padding: '8px 6px 6px 6px', boxShadow: '0 1px 2px rgba(0, 0, 0, 0.1)' }}>
              ...
              />
              <div className="text-xs text-right" style={{ color: '#667781' }}>10:42 AM</div>
            </div>
          </div>
          ...
          <div className="flex justify-end mb-2" style={{ animation: 'slideIn 0.3s ease-out' }}>
            <div className="relative max-w-[85%] min-w-[250px] rounded-lg p-2 px-3" style={{ backgroundColor: '#d9fdd3', boxShadow: '0 1px 2px rgba(0, 0, 0, 0.1)' }}>
              <div className="absolute" style={{ 
                backgroundColor: '#d9fdd3',
                right: '-8px', 
                top: '0', 
          ...
          <div className="flex justify-start mb-2" style={{ animation: 'slideIn 0.3s ease-out' }}>
            <div className="relative max-w-[85%] min-w-[250px] bg-white rounded-lg p-2 px-3" style={{ boxShadow: '0 1px 2px rgba(0, 0, 0, 0.1)' }}>
              ...
              <div className="text-xs text-right" style={{ color: '#667781' }}>10:58 AM</div>
            </div>
          </div>
        </div>
      </main>
